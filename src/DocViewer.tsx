...
import { type DocRenderer, type DocViewerRef, type IConfig, type IDocument, type ITheme } from './models'
...
const DocViewer = forwardRef<DocViewerRef, DocViewerProps>((props, ref) => {
    ...
    return (
        <DocViewerProvider ref={ref} pluginRenderers={DocViewerRenderers} {...props}>
