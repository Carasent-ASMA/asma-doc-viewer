...
import { type IMainState, initialState, mainStateReducer, type MainStateReducer } from './mainStateReducer'
...
const DocViewerProvider = forwardRef<DocViewerRef, PropsWithChildren<DocViewerProps>>((props, ref) => {
    const {
        children,
        documents,
        config,
